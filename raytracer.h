...
private:
	...
	Colour shadeRay( Ray3D& ray, double refractionIndex ); 
	...
	Colour refractReflect( Ray3D& ray, Colour reflectedCol, LightListNode* curLight );
	bool computeRefract( Vector3D norm, Ray3D& rayRefract );
