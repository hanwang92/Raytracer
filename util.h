...
class Material {
    public:
        Material(Colour ambient, Colour diffuse, Colour specular, double exp, double refractiveInd);
        Material(Colour ambient, Colour diffuse, Colour specular, double exp,
                double refractiveInd, char *texture);
...
struct Material {
	Material( Colour ambient, Colour diffuse, Colour specular, double exp, double refractionIndex ):
		ambient(ambient), diffuse(diffuse), specular(specular), 
		specular_exp(exp), refractionIndex(refractionIndex) {}
