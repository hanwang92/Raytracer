...
/*
Material::Material(Colour ambient, Colour diffuse, Colour specular,
        double exp, double refractiveInd) {
    this->ambient = ambient;
    this->diffuse = diffuse;
    this->specular = specular;
    this->refractionIndex = refractiveInd;
    specular_exp = exp;
...
Material::Material(Colour ambient, Colour diffuse, Colour specular,
        double exp, double refractiveInd, char *texture) {
    this->ambient = ambient;
    this->diffuse = diffuse;
    this->specular = specular;
    this->refractionIndex = refractiveInd;
    ...
    this->garray = NULL;
    this->barray = NULL;
    //printf("haha %lu %l %u %u %u\n", width, height, rarray, garray, barray);
    bool res = bmp_read(texture, &width, &height, &rarray, &garray, &barray);
    printf("haha %d\n", res);
}
*/
